...
if ui.get_button("load sendiago") then
  ...
  visual_functions.notify = function()
    local width, height = render.get_text_width(helpers_.fonts_.verdana[12], text) + 239, 50
    local x, y = 510, 750
    ...
    render.text(helpers_.fonts_.verdana[12], x + 13, y + 19, color.new(255, 255, 255, 255 * welcome), text, true)
  end
  -- * end
  ...
  visual_functions.watermark = function()
    ...
    local font = helpers_.fonts_.verdana[12]
    ...
    local width, height = render.get_text_width(helpers_.fonts_.verdana[12], text) + 269, 20
  ...
  visual_functions.indicators = function()
    ...
    -- Font
    local font = helpers_.fonts_.smallest[10]
  ...
  visual_functions.table = function()
    ...
    render.rect_filled_rounded(x, y, 140, 36, 60, 5, color.new(0, 0, 0, 255))
    render.rect_rounded(x + 2, y + 2, 136, 32, color.new(70, 70, 70, 255), 5)
    ...
    render.multitext(x + 6, y + 5, text)
    render.multitext(x + 6, y + 17, text_n)
  end
  -- * end
